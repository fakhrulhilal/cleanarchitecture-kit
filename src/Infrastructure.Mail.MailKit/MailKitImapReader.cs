...
namespace FM.Infrastructure.Mail
{
    public class MailKitImapReader : MailKitMailReader<MailKitImapReader, IImapClient, IMailFolder, UniqueId>
    {
        ...
        protected override async Task<IMailFolder?> InitContainerAsync(IImapClient client, EmailConfig.IncomingConfig config, CancellationToken cancellationToken)
        {
        ...
        protected override async Task<bool> DeleteMessageAsync(IMailFolder container, UniqueId id, CancellationToken cancellationToken)
        {
        ...
        protected override async Task<UniqueId[]> GetMessageIdsAsync(IMailFolder container, int? limit, CancellationToken cancellationToken)
        {
