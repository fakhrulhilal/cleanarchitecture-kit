...
public class GivenCacheBehaviour
{
    ...
    public void Setup() => _bootstrapper.ConfigureServices((services, _) => services
        .AddSingleton(_ => new GeneralConfig { MaxLongRunningTask = 1000 })
        ...
        .AddMediatRHandler<Cached.Query, Cached.Result>(q => new($"result for {q.Id}"))
    ...
    public struct Cached
    {
        ...
        public class
            AbsoluteExpirationRelativeToNowCache : CacheRegistrar<WithAbsoluteExpirationRelativeToNow, Result>
        {
            public AbsoluteExpirationRelativeToNowCache(IDistributedCache distributedCache) : base(
                distributedCache) {
            }
