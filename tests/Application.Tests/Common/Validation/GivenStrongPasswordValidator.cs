...
namespace FM.Application.Tests.Common.Validation
{
    ...
    public class GivenStrongPasswordValidator
    {
        ...
        [Test]
        public void WhenContainsUpperCaseAndLowerCaseAndNumberAndSpecialCharacterAndLongerOrEqualThanMinimumThenItIsValid()
        {
            var sut = new Validator();
        ...
        {
            public Validator(int? minimum = null)
            {
                RuleFor(p => p.Password).StrongPassword(minimum);
            }
        }
    }
}
