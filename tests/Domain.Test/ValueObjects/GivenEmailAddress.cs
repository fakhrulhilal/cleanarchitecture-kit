...
namespace DevKit.Domain.Tests.ValueObjects;
...
public class GivenEmailAddress
{
    ...
    [Test]
    public void
        WhenSerializedIntoStringContainingDisplayNameAndAddressThenDisplayNameWillBeSurroundedByDoubleQuoteAndAddressWillBeSurroundedByLessAndGreaterChar() {
