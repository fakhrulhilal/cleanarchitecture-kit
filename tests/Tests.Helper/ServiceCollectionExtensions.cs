...
namespace FM
{
    ...
    {
        public static IServiceCollection AddMediatRHandler<TRequest>(this IServiceCollection services, Func<TRequest, CancellationToken, Task>? callback = null)
        ...
        public static IServiceCollection AddMediatRHandler<TRequest, TResponse>(this IServiceCollection services, Func<TRequest, TResponse>? factory = null)
        ...
        public static IServiceCollection AddMediatorEventHandler<TDomainEvent>(this IServiceCollection services, Action<TDomainEvent>? callback = null)
